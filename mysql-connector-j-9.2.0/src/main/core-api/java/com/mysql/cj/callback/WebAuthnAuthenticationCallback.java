...
public class WebAuthnAuthenticationCallback implements MysqlCallback {
     ...
     *
     * @return is credential management supported?
     */
     ...
     *
     * @param supportsCredMan is credential management supported?
     */
     ...
     *
     * @param idx the index of the Authenticator Data to return
     ...
     *
     * @param idx the index of the Signature to return
